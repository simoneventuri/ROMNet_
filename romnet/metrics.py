...
def get_metric(MetricName):
    ...
    if isinstance(MetricName, str):
        return metric_identifier[MetricName]
    
    if callable(MetricName):
        return MetricName
    
    raise ValueError("Unrecognized Metric Function!   MetricName = ", MetricName)
