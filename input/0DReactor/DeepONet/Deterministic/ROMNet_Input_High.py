...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, ROMNetFldr):
        ...
        self.PathToRunFld        = self.ROMNetFldr   + '/../0DReact_Isobaric_100Cases_High/'                                 # Path To Training Folder
        self.PathToLoadFld       = self.ROMNetFldr   + '/../0DReact_Isobaric_100Cases_High/DeepONet/Deterministic/Run_1/'                            # Path To Pre-Trained Model Folder
        self.ROMPred_Flg         = True
        self.PathToDataFld       = self.ROMNetFldr   + '/../Data/0DReact_Isobaric_100Cases_High/'+str(self.NRODs)+'PC/'            # Path To Training Data Folder 
