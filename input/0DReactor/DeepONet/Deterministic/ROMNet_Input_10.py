...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, ROMNetFldr):
        ...
        self.PathToLoadFld       = self.ROMNetFldr   + '/../0DReact_Isobaric_10Cases/DeepONet/Deterministic/Run_1/'                            # Path To Pre-Trained Model Folder
        ...
        self.BranchLayers        = [np.array([32,64,128])]*self.NRODs                                            # List Containing the No of Neurons per Each Branch's Layer
        ...
        self.TrunkLayers         = [np.array([32,64,128])]#*self.NRODs                                                # List Containing the No of Neurons per Each Trunk's Layer
        ...
        self.Metrics             = None                   
        self.LR                  = 1.e-7                                                          # Initial Learning Rate
