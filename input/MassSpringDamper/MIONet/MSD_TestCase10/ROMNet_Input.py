...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH):
        ...
        self.path_to_run_fld     = self.ROMNet_fld + '/../MSD_100Cases_UncertainParams/'                                 # Path To Training Folder
        ...
        self.path_to_data_fld    = self.ROMNet_fld + '/../Data/MSD_100Cases_UncertainParams/Orig/'                           # Path To Training-Data Folder 
        ...
        self.input_vars_all      = ['x','v','m','c','k','t']                                                             # List Containing all the Input Data Variable Names
        self.input_vars          = {'MIONet': {'Branch1': ['x','v'],  
                                               'Branch2': ['m','c','k'], 
        ...
        self.structure           = {'MIONet': {'Branch1_1': ['Main'],  
                                               'Branch1_2': ['Main'],
                                               'Branch2_1': ['Main'],  
                                               'Branch2_2': ['Main'],  
                                                 'Trunk_1': ['Main'],
        ...
        self.dropout_rate        = {'MIONet': {'Branch1': {'Main': 1.e-10},  
                                               'Branch2': {'Main': 1.e-10},  
        ...
        self.dotlayer_bias_flg   = {'MIONet': True}
