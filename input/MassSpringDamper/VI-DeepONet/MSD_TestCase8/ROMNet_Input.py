...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH):
        ...
        self.branch_to_trunk     = {'DeepONetMean': 'one_to_one'}                                           # DeepONet Branch-to-Trunk Type of Mapping  ('one_to_one'/'multi_to_one')
        ...
        self.layer_type          = {'DeepONetMean': {'Branch': {'Main': ['TFP','TFP','TFP','TFP']},  
                                                      'Trunk': {'Main': ['TFP','TFP','TFP','TFP']}}}       # Dictionary Containing the Activation Funct.s for each Layer
        ...
        #=======================================================================================================================================
        ### Training Quanties
        self.trainable_flg       = {'DeepONetMean': 'all'}                                                       # Dictionary Containing Instructions for Training Components ('all'/'none'/'only_last')
        ...
        self.lr_decay            = ["exponential", 1000, 0.92]                                              # Instructions for Learning Rate Decay
