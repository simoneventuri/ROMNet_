...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH):
        ...
        self.n_modes             = 8                                                                           # No of Modes (i.e., No of Neurons in Trunch's Last Layer)
        ...
        self.path_to_run_fld     = self.ROMNet_fld + '/../TransTanh_100Cases_All/'                             # Path To Training Folder
        ...
        self.branch_to_trunk     = {'DeepONet': 'multi_to_one'}                                                # DeepONet Branch-to-Trunk Type of Mapping  ('one_to_one'/'multi_to_one')
