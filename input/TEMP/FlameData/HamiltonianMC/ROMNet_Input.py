...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, ROMNetFldr):
        ...
        self.PathToRunFld        = self.ROMNetFldr   + '/../FlameData_Noisy/'                             # Path To Training Folder
        self.PathToTrainDataFld  = self.ROMNetFldr   + '/../Data/FlameData_Noisy/'                        # Path To Training Data Folder 
        self.PathToTestDataFld   = self.ROMNetFldr   + '/../Data/FlameData_Noisy_Test/'                   # Path To Test Data Folder 
        ...
        self.SigmaLike           = 1e-1                                                                   # Likelihood's Standard Deviation
        ...
        #=======================================================================================================================================
        ### Training Quantities
        self.NEpochsHMC          = 450                                                                    # epochs to train for
        self.NEpochsBurnIn       = 10                                                                     # number of burnin epochs
