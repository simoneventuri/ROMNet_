...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, ROMNet_fld):
        ...
        self.path_to_run_fld        = self.ROMNet_fld   + '/../MSD_10Cases/'                                 # Path To Training Folder
        self.path_to_load_fld       = None                                                                   # Path To Pre-Trained Model Folder
        self.path_to_data_fld       = self.ROMNet_fld   + '/../Data/MSD_10Cases/'                            # Path To Training Data Folder 
        ...
        self.InputVars           = ['t','x','v']                                                          # List Containing the Input Data Column Names 
        self.OutputVars          = ['x','v']                                                              # List Containing the Output Data Column Names
        self.TransFun            = {'NN': None}                                                           # Dictionary of Functions to Be Applied to the Input Data
