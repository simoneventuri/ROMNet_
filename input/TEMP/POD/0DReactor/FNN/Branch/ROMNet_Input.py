...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, ROMNetFldr):
        ...
        self.PathToRunFld        = self.ROMNetFldr   + '/../0DReact_Isobaric_500Cases_Up_POD_'+POD_NAME+'_Branch/'           # Path To Training Folder
        ...
        self.PathToDataFld       = self.ROMNetFldr   + '/../Data/0DReact_Isobaric_500Cases_Up/'+str(self.NRODs)+'PC/OneByOne/POD_'+POD_NAME+'/Branch/'           # Path To Training Data Folder 
