...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH):
        ...
        self.path_to_run_fld      = self.ROMNet_fld   + '/../MSD_100Cases_'+str(self.NRODs)+self.DRAlog+'/Var'+str(self.iVar)+'_Branch/'           # Path To Training Folder
        ...
        self.path_to_data_fld    = self.ROMNet_fld   + '/../Data/MSD_100Cases/'+str(self.NRODs)+self.DRAlog+'/'+self.DRType+'/'+'/Var'+str(self.iVar)+'/Branch/'      # Path To Training Data Folder 
        self.Vars                = ['b_'+str(i+1) for i in range(self.NRODs)]+['c']
        self.output_vars         = self.Vars                                                                             # List Containing the Output Data Variable Names for each System
        self.input_vars_all      = ['x0','v0']                                                                    # List Containing all the Input Data Variable Names
        self.input_vars          = {'FNN': {'FNN': ['x0','v0']}}                                                       # Dictionary Containing the Input  Data Variable Names for each Component
        
        # -----------------------------------------------------------------------------------
        self.structure               = {'FNN': {}}
        self.structure['FNN']['FNN'] = ['Main']
        self.n_neurons               = {'FNN': {'FNN': {'Main': np.array([32,32,32,self.NRODs+1])}}} # Dictionary Containing the No of Neurons for each Layer
        ...
        self.n_epoch             = 300000                                                                    # Number of Epoches
