...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH):
        ...
        self.path_to_run_fld      = self.ROMNet_fld   + '/../MSD_100Cases_'+str(self.NRODs)+self.DRAlog+'/Var'+str(self.iVar)+'_Trunk/'           # Path To Training Folder
        ...
        self.path_to_data_fld    = self.ROMNet_fld   + '/../Data/MSD_100Cases/'+str(self.NRODs)+self.DRAlog+'/'+self.DRType+'/'+'/Var'+str(self.iVar)+'/Trunk/'      # Path To Training Data Folder 
