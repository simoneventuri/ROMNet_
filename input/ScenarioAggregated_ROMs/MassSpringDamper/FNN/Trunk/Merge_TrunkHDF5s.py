...
path_to_orig_fld = ROMNet_fld + '/input/ScenarioAggregated_ROMs/MassSpringDamper/FNN/Trunk/'
path_to_run_fld_ = ROMNet_fld + '/../MSD_100Cases_'+str(NRODs)+DRAlog+'/Var'+str(iVar)+'_Trunk/' 
