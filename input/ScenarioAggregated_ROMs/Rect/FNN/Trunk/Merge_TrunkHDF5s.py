...
path_to_run_fld_ = ROMNet_fld + '/../Rect_200Instants_TransRotScale_'+str(NRODs)+DRAlog+'/Var'+str(iVar)+'_Trunk/' 
...
try:
    os.makedirs(InputData.path_to_data_fld+'/../../FNN_Trunks/')
except:
    pass
filename_new = InputData.path_to_data_fld+'/../../FNN_Trunks/Final.h5'
