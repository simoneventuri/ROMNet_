...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH):
        ...
        self.path_to_run_fld      = self.ROMNet_fld   + '/../PlasmaSyst_500Cases_'+str(self.NRODs)+self.DRAlog+'/Var'+str(self.iVar)+'_Trunk/'           # Path To Training Folder
        ...
        self.path_to_data_fld    = self.ROMNet_fld   + '/../Data/PlasmaSyst_500Cases/'+str(self.NRODs)+self.DRAlog+'/'+self.DRType+'/'+'/Var'+str(self.iVar)+'/Trunk/'      # Path To Training Data Folder 
