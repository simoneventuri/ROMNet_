...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, SurQCTFldr):
        ...
        self.PathToRunFld        = self.SurQCTFldr + '/../3PC_BNN' + str(self.NNRunIdx)                   # Path To Training Folder
        ...
        self.PathToDataFld       = self.WORKSPACE_PATH + '/PCA/Test_DeepONet/deeponet/'                   # Path To Training Data Folder 
        ...
        self.PINN                = False
        self.BranchVars          = ['Rest']
        self.BranchScale         = np.log10
        self.BranchLayers        = [np.array([32,32,32]), np.array([32,32,32]), np.array([32,32,32])]
        self.BranchActFun        = [['elu','elu','elu'],  ['elu','elu','elu'],  ['elu','elu','elu']]
