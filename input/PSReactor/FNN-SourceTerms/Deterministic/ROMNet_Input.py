...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, ROMNetFldr):
        ...
        self.InputFile           = 'PC.csv'                                                               # Name of the File Containing the Input Data
        self.InputVars           = ['PC_1','PC_2','PC_3']                                                 # List Containing the Input Data Column Names 
        ...
        self.OutputFile          = 'PCSource.csv'                                                         # Name of the File Containing the Output Data
        self.OutputVars          = ['SPC_1','SPC_2','SPC_3']                                              # List Containing the Output Data Column Names
        ...
        self.MiniBatchSize       = 128                                                                    # Mini-Batch Size
